...
## 5. Создай раздел "Текущие проекты" и помести в нём ссылку на страницу курса "Основы веб-программирования".
Для создания ссылки используется тег `<a>` и его атрибут `href`. Атрибут помещается в открывающем теге, в качестве значения следует указать адрес ресурса в интернете (URL): https://dfisun.github.io/webdev-w2018/
